...
You should use input to read a string and float() to convert the string to a number. Do not worry about
...
rph = float(rph)
#permanent multiply for rph if hrs>40
permmulti = 1.5
if hrs>40:
    hrsleft=hrs-40
    hrs=hrs-hrsleft
    ...
    hrsleft=0
total=(hrs*rph)+(hrsleft*(rph*permmulti))
print(total)
